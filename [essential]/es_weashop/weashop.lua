...
local weashop = {
	...
	menu = {
		...
		["main"] = {
			...
			name = "main",
			buttons = {
				{title = "Meele", name = "Melee", description = ""},
				{title = "Pistol", name = "Pistolets", description = ""},
				{title = "Machine Guns", name = "MachineGuns", description = ""},
				{title = "Shotguns", name = "Shotguns", description = ""},
		...
		["Melee"] = {
			...
			name = "Melee",
			buttons = {
				{title = "Knife", name = "Knife", costs = 400, description = {}, model = "WEAPON_Knife"},
				{title = "Hammer", name = "Hammer", costs = 500, description = {}, model = "WEAPON_HAMMER"},
				{title = "Bat", name = "Bat", costs = 750, description = {}, model = "WEAPON_Bat"},
				{title = "Bottle", name = "Bottle", costs = 300, description = {}, model = "WEAPON_Bottle"},
				{title = "Dagger", name = "Dagger", costs = 2000, description = {}, model = "WEAPON_Dagger"},
				{title = "Hatchet", name = "Hatchet", costs = 750, description = {}, model = "WEAPON_Hatchet"},
				{title = "Knuckle Duster", name = "KnuckleDuster", costs = 7500, description = {}, model = "WEAPON_KNUCKLE"},
				--{title = "Machette", name = "Machete", costs = 8900, description = {}, model = "WEAPON_Machete"},							DLC ARMES ET VEHICULES A GOGO
				{title = "Flashlight", name = "Flashlight", costs = 5750, description = {}, model = "WEAPON_Flashlight"},
		...
		["Pistolets"] = {
			...
			name = "Pistolets",
			buttons = {
				{title = "Pistol", name = "Pistol", costs = 250000, description = {}, model = "WEAPON_Pistol"},
				...
				{title = "Heavy Pistol", name = "HeavyPistol", costs = 375000, description = {}, model = "WEAPON_HeavyPistol"},
				{title = "Vintage Pistol", name = "VintagePistol", costs = 345000, description = {}, model = "WEAPON_VintagePistol"},
				...
				{title = "Flare gun", name = "FlareGun", costs = 5750, description = {}, model = "WEAPON_FlareGun"},
			}
		},
		["MachineGuns"] = {
			title = "Fusils",
			name = "MachineGuns",
			buttons = {
				{title = "Micro SMG", name = "MicroSMG", costs = 375000, description = {}, model = "WEAPON_MicroSMG"},
				{title = "Machine Pistol", name = "MachinePistol", costs = 625000, description = {}, model = "WEAPON_MachinePistol"},
				--{title = "MP5A3", name = "SMG", costs = 750000, description = {}, model = "WEAPON_SMG"},								DLC ARMES ET VEHICULES A GOGO
				{title = "Assualt SMG", name = "AssaultSMG", costs = 1250000, description = {}, model = "WEAPON_AssaultSMG"},
				{title = "Combat PDW", name = "CombatPDW", costs = 1175000, description = {}, model = "WEAPON_CombatPDW"},
		...
		["Shotguns"] = {
			...
			name = "Shotguns",
			buttons = {
				{title = "Pump Shotgun", name = "PumpShotgun", costs = 350000, description = {}, model = "WEAPON_PumpShotgun"},
				{title = "Sawn off Shotgun", name = "SawnoffShotgun", costs = 300000, description = {}, model = "WEAPON_SawnoffShotgun"},
		...
		["ThrownWeapons"] = {
			...
			buttons = {
				...
				{title = "BZ Gas", name = "BZGas", costs = 8500, description = {}, model = "WEAPON_BZGas"},
				...
				{title = "Petrol Can", name = "PetrolCan", costs = 8500, description = {}, model = "WEAPON_PetrolCan"},
			...
			while #weashop_blips > 0 do
				...
				for i,b in ipairs(weashop_blips) do
					if IsPlayerWantedLevelGreater(GetPlayerIndex(),0) == false and weashop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 2 then
						...
						drawTxt('Press ~g~ENTRER~s~ to buy ~b~weapons',0,1,0.5,0.8,0.6,255,255,255,255)
						currentlocation = b
						inrange = true
					end
				end
