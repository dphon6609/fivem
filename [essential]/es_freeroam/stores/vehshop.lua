...
local vehshop = {
	...
	menu = {
		...
		["super"] = {
			...
			name = "super",
			buttons = {
				{name = "Buggati", costs = 3500000, description = {}, model = "adder"},
				...
				{name = "Maybach 6", costs = 5550000, description = {}, model = "tyrus"},
		...
		["offroad"] = {
			...
			name = "off-road",
			buttons = {
				{name = "Tow Truck", costs = 5, description = {}, model = "flatbed"},
			...
			while #vehshop_blips > 0 do
				...
				for i,b in ipairs(vehshop_blips) do
					...
					if vehshop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 5 then
						drawTxt('Press ~g~ENTER~s~ to access the menu d\'purchase',0,1,0.5,0.8,0.6,255,255,255,255)
						currentlocation = b
						inrange = true
					end
				end
