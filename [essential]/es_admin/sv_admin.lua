...
TriggerEvent('es:addAdminCommand', 'me', permission.normal, function(source, args, user)
	table.remove(args, 1)
	TriggerClientEvent('chatMessage', -1, "^3[Me]", {255, 0, 0}, " (^3 " .. GetPlayerName(source) .." | "..source.."^0 ) " .. table.concat(args, " "))
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end)

-- Global Chat
TriggerEvent('es:addAdminCommand', 'g', permission.normal, function(source, args, user)
	table.remove(args, 1)
	TriggerClientEvent('chatMessage', -1, "^3Global |", {255, 255, 0}, "^3" .. GetPlayerName(source) .. "^0 " .. table.concat(args, " "))
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end)
